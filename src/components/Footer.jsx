    ...
    <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20 font-["Founders_Grotesk_X-Condensed"]'>
      <div className=' w-1/2 h-full flex flex-col justify-between  '>
        <div className='heading'>
            ...
            <h1 className='text-[7vw] font-semibold uppercase leading-none -mb-5'>Opening</h1>
        </div>
      ...
      <div className='w-1/2'>
      <h1 className='text-[5vw] font-semibold uppercase leading-none tracking-tighter -mb-10'>
        Presentations
        </h1>

          <div className='dets font-["Neue_Montreal"] mt-20 '>
            <a className='block text-2xl text-light' href="">Facebook</a>
            <a className='block text-2xl text-light' href="">Instagram</a>
            <a className='block text-2xl text-light' href="">Twitter</a>
            <a className='block text-2xl text-light' href="">Balance</a>
            <a className='block text-2xl text-light' href="">LinkedIn</a>
